...
class Game(db.Model, SerializerMixin):
    ...
    # Association proxy to get the users who have reviewed a particular game as there is a many to many relationship between 
    # users and the games via the reviews 
